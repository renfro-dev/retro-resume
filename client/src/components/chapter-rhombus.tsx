                ...
                <div className="flex space-x-1">
                  {externalLinks.map((link, idx) => (
                    <a 
                      ...
                      className="bg-transparent border border-[var(--terminal-green)] text-[var(--terminal-green)] px-1.5 py-0.5 font-mono text-xs hover:bg-[var(--terminal-green)] hover:text-black transition-all duration-300 scale-[0.85]"
                    >
                      {link.text}
                    </a>
                  ))}
